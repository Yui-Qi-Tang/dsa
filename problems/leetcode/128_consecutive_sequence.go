...
func longestConsecutivev55(nums []int) int {
...
func longestConsecutivev54(nums []int) int {
	m := make(map[int]bool, len(nums))
	for _, num := range nums {
		m[num] = true
	}
...
func longestConsecutivev53(nums []int) int {
	m := make(map[int]bool, len(nums))
	for _, num := range nums {
		m[num] = true
	}
...
func longestConsecutivev52(nums []int) int {
	m := make(map[int]bool, len(nums))
	for _, num := range nums {
		m[num] = true
	}
...
func longestConsecutivev51(nums []int) int {
	m := make(map[int]bool, len(nums))
	for _, num := range nums {
		m[num] = true
	}
...
func longestConsecutivev50(nums []int) int {
	m := make(map[int]bool, len(nums))
	for _, num := range nums {
		m[num] = true
	}
...
func longestConsecutivev49(nums []int) int {
	m := make(map[int]bool, len(nums))
	for _, num := range nums {
		m[num] = true
	}
...
func longestConsecutivev48(nums []int) int {
	m := make(map[int]bool, len(nums))
	for _, num := range nums {
		m[num] = true
	}
...
func longestConsecutivev47(nums []int) int {
	m := make(map[int]bool, len(nums))
	for _, num := range nums {
		m[num] = true
	}
...
func longestConsecutivev46(nums []int) int {
	m := make(map[int]bool, len(nums))
	for _, num := range nums {
		m[num] = true
	}
...
func longestConsecutivev45(nums []int) int {
	m := make(map[int]bool, len(nums))
	for _, num := range nums {
		m[num] = true
	}
...
func longestConsecutivev44(nums []int) int {
	result := 0
...
func longestConsecutivev43(nums []int) int {
	m := make(map[int]bool, len(nums))
	for i := range nums {
		m[nums[i]] = true
	}
...
func longestConsecutivev42(nums []int) int {
	m := make(map[int]bool, len(nums))
	for _, num := range nums {
		m[num] = true
	}
...
func longestConsecutivev41(nums []int) int {
	m := make(map[int]bool)
	for i := range nums {
		m[nums[i]] = true
	}
...
func longestConsecutivev40(nums []int) int {
	m := make(map[int]bool)
...
func longestConsecutivev29(nums []int) int {
	m := make(map[int]bool)
...
func longestConsecutivev28(nums []int) int {
	m := make(map[int]bool, len(nums))
	for _, num := range nums {
		m[num] = true
	}
...
func longestConsecutivev27(nums []int) int {
	m := make(map[int]bool)
...
func longestConsecutivev26(nums []int) int {
	m := make(map[int]bool, len(nums))
	for _, num := range nums {
		m[num] = true
	}
