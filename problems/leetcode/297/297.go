...
func constructorv30() codecv30 {
	return codecv30{null: "n", join: ","}
}

type codecv30 struct {
	null, join string
}

func (c codecv30) serialize(root *TreeNode) string {
	if root == nil {
		return ""
	}
...
func (c codecv30) deserialize(data string) *TreeNode {
	if len(data) == 0 {
		return nil
	}
...
func constructorv29() codecv29 {
	return codecv29{null: "n", join: ","}
}

type codecv29 struct {
	null, join string
}

func (c codecv29) serialize(root *TreeNode) string {
	if root == nil {
		return ""
	}
...
func (c codecv29) deserialize(data string) *TreeNode {
	if len(data) == 0 {
		return nil
	}
...
func constructorv28() codecv28 {
	return codecv28{null: "n", join: ","}
}

type codecv28 struct {
	null, join string
}

func (c codecv28) serialize(root *TreeNode) string {
	if root == nil {
		return ""
	}
...
func (c codecv28) deserialize(data string) *TreeNode {
	if len(data) == 0 {
		return nil
	}
...
func constructorv27() codecv27 {
	return codecv27{null: "x", join: "+"}
}

type codecv27 struct {
	null, join string
}

func (c codecv27) serialize(root *TreeNode) string {
	if root == nil {
		return ""
	}
...
func (c codecv27) deserialize(data string) *TreeNode {
	if len(data) == 0 {
		return nil
	}
