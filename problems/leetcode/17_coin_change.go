...
func coinChangev60(coins []int, amount int) int {
...
func coinChangev59(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev58(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev57(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev56(coins []int, amount int) int {
	dp := make([]int, amount+1)
	for i := 1; i <= amount; i++ {
		q := math.MaxInt
		for _, coin := range coins {
...
func coinChangev55(coins []int, amount int) int {
	dp := make([]int, amount+1)
	for i := 1; i <= amount; i++ {
		q := math.MaxInt
		for _, coin := range coins {
...
func coinChangev54(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev53(coins []int, amount int) int {
	dp := make([]int, amount+1)
	for i := 1; i <= amount; i++ {
		q := math.MaxInt
		for _, coin := range coins {
...
func coinChangev52(coins []int, amount int) int {
	dp := make([]int, amount+1)
	for i := 1; i <= amount; i++ {
		q := math.MaxInt
		for _, coin := range coins {
...
func coinChangev51(coins []int, amount int) int {
	dp := make([]int, amount+1)
	for i := 1; i <= amount; i++ {
		q := math.MaxInt
		for _, coin := range coins {
...
func coinChangev50(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev49(coins []int, amount int) int {
	dp := make([]int, amount+1)
	for i := 1; i <= amount; i++ {
		q := math.MaxInt
		for _, coin := range coins {
...
func coinChangev48(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev47(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev46(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev45(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev44(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev43(coins []int, amount int) int {
	dp := make([]int, amount+1)
	for i := 1; i <= amount; i++ {
		q := math.MaxInt
		for _, coin := range coins {
...
func coinChangev42(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev41(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev40(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev39(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev38(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev37(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev36(coins []int, amount int) int {
	dp := make([]int, amount+1)
...
func coinChangev35(coins []int, amount int) int {
	dp := make([]int, amount+1)
