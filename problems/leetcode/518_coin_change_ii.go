...
func changev100(amount int, coins []int) int {
...
func changev99(amount int, coins []int) int {
...
func changev98(amount int, coins []int) int {
	dp := make(map[[2]int]int)
	var backtrace func(i, amt int) int
	backtrace = func(i, amt int) int {
		if i == len(coins) {
...
func changev97(amount int, coins []int) int {
	dp := make([]int, amount+1)
	dp[0] = 1
	for _, coin := range coins {
		for i := coin; i <= amount; i++ {
...
func changev96(amount int, coins []int) int {
	dp := make(map[[2]int]int)
	var backtrace func(i, amt int) int
	backtrace = func(i, amt int) int {
		if i == len(coins) {
...
func changev95(amount int, coins []int) int {
	dp := make([]int, amount+1)
	dp[0] = 1
	for _, coin := range coins {
		for i := coin; i <= amount; i++ {
...
func changev94(amount int, coins []int) int {
	dp := make([]int, amount+1)
	dp[0] = 1
	for _, coin := range coins {
		for i := coin; i <= amount; i++ {
...
func changev93(amount int, coins []int) int {
	dp := make(map[[2]int]int)
	var backtrace func(i, amt int) int
	backtrace = func(i, amt int) int {
		if i == len(coins) {
