...
func minCostClimbingStairsv50(cost []int) int {
...
func minCostClimbingStairsv49(cost []int) int {
	a, b := cost[len(cost)-1], 0
	for i := len(cost) - 2; i >= 0; i-- {
		cost[i] += min(a, b)
		b = a
...
func minCostClimbingStairsv48(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv47(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv46(cost []int) int {
	a, b := cost[len(cost)-1], 0
	for i := len(cost) - 2; i >= 0; i-- {
		cost[i] += min(a, b)
		b = a
...
func minCostClimbingStairsv45(cost []int) int {
	a, b := cost[len(cost)-1], 0
	for i := len(cost) - 2; i >= 0; i-- {
		cost[i] += min(a, b)
		b = a
...
func minCostClimbingStairsv44(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv43(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv42(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv41(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv40(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv39(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv38(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv37(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv36(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv35(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv34(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv33(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv32(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv31(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv30(cost []int) int {
	a, b := cost[len(cost)-1], 0
	for i := len(cost) - 2; i >= 0; i-- {
		cost[i] += min(a, b)
		b = a
...
func minCostClimbingStairsv29(cost []int) int {
	a, b := cost[len(cost)-1], 0
...
func minCostClimbingStairsv28(cost []int) int {
	a, b := cost[len(cost)-1], 0
