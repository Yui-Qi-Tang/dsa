...
func maxPathSumv30(root *TreeNode) int {
	var ms func(n *TreeNode) int
	result := 0
	ms = func(n *TreeNode) int {
		if n == nil {
			return 0
		}

		lmax := max(0, ms(n.Left))
		rmax := max(0, ms(n.Right))
...
func maxPathSumv29(root *TreeNode) int {
	result := 0
	var ms func(n *TreeNode) int
...
func maxPathSumv28(root *TreeNode) int {
	var ms func(n *TreeNode) int
...
func maxPathSumv27(root *TreeNode) int {
	var ms func(n *TreeNode) int
	result := 0
...
func maxPathSumv26(root *TreeNode) int {
	result := 0
	var ms func(n *TreeNode) int
	ms = func(n *TreeNode) int {
		if n == nil {
...
func maxPathSumv25(root *TreeNode) int {
	result := 0
	var ms func(n *TreeNode) int
	ms = func(n *TreeNode) int {
		if n == nil {
...
func maxPathSumv24(root *TreeNode) int {
	result := 0
	var ms func(n *TreeNode) int
	ms = func(n *TreeNode) int {
		if n == nil {
...
func maxPathSumv23(root *TreeNode) int {
	result := 0
	var ms func(n *TreeNode) int
...
func maxPathSumv22(root *TreeNode) int {
	result := 0
	var ms func(n *TreeNode) int
...
func maxPathSumv21(root *TreeNode) int {
	result := 0
	var mps func(n *TreeNode) int // max path sum

	mps = func(n *TreeNode) int {
		if n == nil {
			return 0
		}

		lmax := max(0, mps(n.Left))
		rmax := max(0, mps(n.Right))
		result = max(result, n.Val+lmax+rmax)
		return n.Val + max(lmax, rmax)
	}
...
func maxPathSumv20(root *TreeNode) int {
	result := 0
...
func maxPathSumv19(root *TreeNode) int {
	result := 0
	var maxsum func(n *TreeNode) int
...
func maxPathSumv18(root *TreeNode) int {
	result := 0
	var maxsum func(n *TreeNode) int
...
func maxPathSumv17(root *TreeNode) int {
	result := 0
...
func maxPathSumv16(root *TreeNode) int {
	result := 0
...
func maxPathSumv13(root *TreeNode) int {
	result := 0
	var maxSum func(n *TreeNode) int
...
func maxPathSumv12(root *TreeNode) int {
	var maxsum func(n *TreeNode) int
	result := 0
...
func maxPathSumv11(root *TreeNode) int {
	result := 0
	if root == nil {
		return result
	}
