...
func TestMinCostClimbingStairs(t *testing.T) {
	...
	testFuncs := []func([]int) int{
		minCostClimbingStairsv50,
		minCostClimbingStairsv49,
		minCostClimbingStairsv48,
		minCostClimbingStairsv47,
		minCostClimbingStairsv46,
		minCostClimbingStairsv45,
		minCostClimbingStairsv44,
		minCostClimbingStairsv43,
		minCostClimbingStairsv42,
		minCostClimbingStairsv41,
		minCostClimbingStairsv40,
		minCostClimbingStairsv39,
		minCostClimbingStairsv38,
		minCostClimbingStairsv37,
		minCostClimbingStairsv36,
		minCostClimbingStairsv35,
