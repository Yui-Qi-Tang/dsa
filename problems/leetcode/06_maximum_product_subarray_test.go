...
func TestMaximumProductSubarray(t *testing.T) {
	...
	testfuncs := []func([]int) int{
		MaximumProductSubarrayv30,
		MaximumProductSubarrayv29,
		MaximumProductSubarrayv28,
		MaximumProductSubarrayv27,
		MaximumProductSubarrayv26,
		MaximumProductSubarrayv25,
		MaximumProductSubarrayv24,
		MaximumProductSubarrayv23,
		MaximumProductSubarrayv22,
		MaximumProductSubarrayv21,
		MaximumProductSubarrayv20,
		MaximumProductSubarrayv19,
		MaximumProductSubarrayv18,
		MaximumProductSubarrayv17,
		MaximumProductSubarrayv16,
		MaximumProductSubarrayv15,
		MaximumProductSubarrayv14,
		MaximumProductSubarrayv13,
		MaximumProductSubarrayv12,
		MaximumProductSubarrayv11,
