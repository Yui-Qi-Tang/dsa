...
func TestLongestConsecutive(t *testing.T) {
	...
	testFuncs := []func(nums []int) int{
		longestConsecutivev55,
		longestConsecutivev54,
		longestConsecutivev53,
		longestConsecutivev52,
		longestConsecutivev51,
		longestConsecutivev50,
		longestConsecutivev49,
		longestConsecutivev48,
		longestConsecutivev47,
		longestConsecutivev46,
		longestConsecutivev45,
		longestConsecutivev44,
		longestConsecutivev43,
		longestConsecutivev42,
		longestConsecutivev41,
		longestConsecutivev40,
		longestConsecutivev39,
		longestConsecutivev38,
		longestConsecutivev37,
		longestConsecutivev36,
