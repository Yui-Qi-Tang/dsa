...
func levelOrderv30(root *TreeNode) [][]int {
	result := [][]int{}
	if root == nil {
		return result
	}
...
func levelOrderv29(root *TreeNode) [][]int {
	result := [][]int{}
	if root == nil {
		return result
	}
...
func levelOrderv28(root *TreeNode) [][]int {
	result := [][]int{}
	if root == nil {
		return result
	}
...
func levelOrderv27(root *TreeNode) [][]int {
	result := [][]int{}
	if root == nil {
		return result
	}
...
func levelOrderv26(root *TreeNode) [][]int {
	result := [][]int{}
...
func levelOrderv25(root *TreeNode) [][]int {
	result := [][]int{}
	if root == nil {
		return result
	}
...
func levelOrderv24(root *TreeNode) [][]int {
	result := [][]int{}
	if root == nil {
		return result
	}
...
func levelOrderv23(root *TreeNode) [][]int {
	result := [][]int{}
	if root == nil {
		return result
	}
...
func levelOrderv22(root *TreeNode) [][]int {
	result := [][]int{}
	if root == nil {
		return result
	}
...
func levelOrderv21(root *TreeNode) [][]int {
	result := [][]int{}
	if root == nil {
		return result
	}
