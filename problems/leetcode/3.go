...
func lengthOfLongestSubstringv32(s string) int {
	dup := make(map[byte]bool, len(s))
	l := 0
	result := 0
	for r := range s {
		for dup[s[r]] {
...
func lengthOfLongestSubstringv31(s string) int {
	dup := make(map[byte]bool, len(s))
	result := 0
...
func lengthOfLongestSubstringv30(s string) int {
	dup := make(map[byte]bool, len(s))
	result := 0
...
func lengthOfLongestSubstringv29(s string) int {
	dup := make(map[byte]bool, len(s))
	result := 0
...
func lengthOfLongestSubstringv28(s string) int {
	dup := make(map[byte]bool, len(s))
	result := 0
...
func lengthOfLongestSubstringv27(s string) int {
	dup := make(map[byte]bool, len(s))
	result := 0
...
func lengthOfLongestSubstringv26(s string) int {
	dup := make(map[byte]bool, len(s))
	result := 0
...
func lengthOfLongestSubstringv25(s string) int {
	dup := make(map[byte]bool, len(s))
	result := 0
...
func lengthOfLongestSubstringv24(s string) int {
...
func lengthOfLongestSubstringv23(s string) int {
	dup := make(map[byte]bool)
	result := 0
...
func lengthOfLongestSubstringv22(s string) int {
	dup := make(map[byte]bool, 0)
	result := 0
...
func lengthOfLongestSubstringv21(s string) int {
	dup := make(map[byte]bool, 0)
	result := 0
...
func lengthOfLongestSubstringv20(s string) int {
	dup := map[byte]bool{}
	result := 0
...
func lengthOfLongestSubstringv19(s string) int {
	dup := map[byte]bool{}
	result := 0
...
func lengthOfLongestSubstringv18(s string) int {
	dup := make(map[byte]bool)
	result := 0
