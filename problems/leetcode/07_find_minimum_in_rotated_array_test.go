...
func TestFindMinRotatedSortedArray(t *testing.T) {
	...
	testfuncs := []func([]int) int{
		findMinRotatedSortedArrayv30,
		findMinRotatedSortedArrayv29,
		findMinRotatedSortedArrayv28,
		findMinRotatedSortedArrayv27,
		findMinRotatedSortedArrayv26,
		findMinRotatedSortedArrayv25,
		findMinRotatedSortedArrayv24,
		findMinRotatedSortedArrayv23,
		findMinRotatedSortedArrayv22,
		findMinRotatedSortedArrayv21,
		findMinRotatedSortedArrayv20,
