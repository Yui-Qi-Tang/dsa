...
func missingNumberv28(nums []int) int {
	total := ((1 + len(nums)) * len(nums)) / 2
...
func missingNumberv27(nums []int) int {
	total := ((1 + len(nums)) * len(nums)) / 2
...
func missingNumberv26(nums []int) int {
	total := ((1 + len(nums)) * len(nums)) / 2
	for i := range nums {
		total -= nums[i]
	}
...
func missingNumberv25(nums []int) int {
	total := ((1 + len(nums)) * len(nums)) / 2
	for i := range nums {
		total -= nums[i]
	}
...
func missingNumberv24(nums []int) int {
	total := ((1 + len(nums)) * len(nums)) / 2
	for i := range nums {
		total -= nums[i]
	}
...
func missingNumberv23(nums []int) int {
	total := ((1 + len(nums)) * len(nums)) / 2
	for i := range nums {
		total -= nums[i]
	}
...
func missingNumberv22(nums []int) int {
	total := ((1 + len(nums)) * len(nums)) / 2
...
func missingNumberv21(nums []int) int {
	total := ((1 + len(nums)) * len(nums)) / 2
...
func missingNumberv20(nums []int) int {
	total := ((1 + len(nums)) * len(nums)) / 2
...
func missingNumberv19(nums []int) int {
	total := ((1 + len(nums)) * len(nums)) / 2
...
func missingNumberv18(nums []int) int {
	total := ((1 + len(nums)) * len(nums)) / 2
