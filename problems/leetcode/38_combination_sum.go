...
func combinationSumv53(candicates []int, target int) [][]int {
	result := make([][]int, 0)
	var backtrace func(i, sum int, curr []int)
	backtrace = func(i, sum int, curr []int) {
		...
		backtrace(i+1, sum, curr)
		curr = append(curr, candicates[i])
		backtrace(i, sum+candicates[i], curr)
	}
	backtrace(0, 0, []int{})
	return result
}

func combinationSumv52(candicates []int, target int) [][]int {
	result := make([][]int, 0)
	var backtrace func(i, sum int, curr []int)
	backtrace = func(i, sum int, curr []int) {
		if i == len(candicates) || sum > target {
...
func combinationSumv51(candicates []int, target int) [][]int {
	result := make([][]int, 0)
...
func combinationSumv50(candicates []int, target int) [][]int {
	result := make([][]int, 0)
	var dfs func(i, sum int, curr []int)
	dfs = func(i, sum int, curr []int) {
		if i == len(candicates) || sum > target {
...
func combinationSumv49(candicates []int, target int) [][]int {
	result := make([][]int, 0)
...
func combinationSumv48(candicates []int, target int) [][]int {
	result := make([][]int, 0)
...
func combinationSumv47(candicates []int, target int) [][]int {
	result := make([][]int, 0)
...
func combinationSumv46(candicates []int, target int) [][]int {
	result := make([][]int, 0)
...
func combinationSumv45(candicates []int, target int) [][]int {
	result := make([][]int, 0)
...
func combinationSumv42(candicates []int, target int) [][]int {
	result := make([][]int, 0)
...
func combinationSumv41(candicates []int, target int) [][]int {
	result := make([][]int, 0)
...
func combinationSumv40(candicates []int, target int) [][]int {
	result := make([][]int, 0)
	var dfs func(i, sum int, curr []int)
	dfs = func(i, sum int, curr []int) {
		if i >= len(candicates) || sum > target {
...
func combinationSumv39(candicates []int, target int) [][]int {
	result := make([][]int, 0)
