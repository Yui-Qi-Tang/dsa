...
func kthSmallestv30(root *TreeNode, k int) int {
...
func kthSmallestv29(root *TreeNode, k int) int {
	stack := make([]*TreeNode, 0)
	p := root
...
func kthSmallestv28(root *TreeNode, k int) int {
	stack := make([]*TreeNode, 0)
...
func kthSmallestv27(root *TreeNode, k int) int {
	stack := []*TreeNode{}
...
func kthSmallestv26(root *TreeNode, k int) int {
	stack := []*TreeNode{}
