...
func isSameTreev30(p, q *TreeNode) bool {
	if p == nil || q == nil {
		return p == q
	}
	...
	return isSameTreev30(p.Left, q.Left) && isSameTreev30(p.Right, q.Right)
}

func isSameTreev29(p, q *TreeNode) bool {
	if p == nil || q == nil {
		return p == q
	}
	...
	return isSameTreev29(p.Left, q.Left) && isSameTreev29(p.Right, q.Right)
}

func isSameTreev28(p, q *TreeNode) bool {
	if p == nil || q == nil {
		return p == q
	}
	...
	return isSameTreev28(p.Left, q.Left) && isSameTreev28(p.Right, q.Right)
}

func isSameTreev27(p, q *TreeNode) bool {
	if p == nil || q == nil {
		return p == q
	}
	...
	return isSameTreev27(p.Left, q.Left) && isSameTreev27(p.Right, q.Right)
}

func isSameTreev26(p, q *TreeNode) bool {
	if p == nil || q == nil {
		return p == q
	}
	...
	return isSameTreev26(p.Left, q.Left) && isSameTreev26(p.Right, q.Right)
}

func isSameTreev25(p, q *TreeNode) bool {
	if p == nil || q == nil {
		return p == q
	}
	...
	return isSameTreev25(p.Left, q.Left) && isSameTreev25(p.Right, q.Right)
}

func isSameTreev24(p, q *TreeNode) bool {
	if p == nil || q == nil {
		return p == q
	}
	...
	return isSameTreev24(p.Left, q.Left) && isSameTreev24(p.Right, q.Right)
}

func isSameTreev23(p, q *TreeNode) bool {
	if p == nil || q == nil {
		return p == q
	}
	...
	return isSameTreev23(p.Left, q.Left) && isSameTreev23(p.Right, q.Right)
}
