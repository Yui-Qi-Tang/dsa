...
func lowestCommonAncestorv30(root, p, q *TreeNode) *TreeNode {

	if p.Val > root.Val && q.Val > root.Val {
		return lowestCommonAncestorv30(root.Right, p, q)
	}

	if p.Val < root.Val && q.Val < root.Val {
		return lowestCommonAncestorv30(root.Left, p, q)
	}

	return root
}

func lowestCommonAncestorv29(root, p, q *TreeNode) *TreeNode {

	if p.Val > root.Val && q.Val > root.Val {
		return lowestCommonAncestorv29(root.Right, p, q)
	}

	if p.Val < root.Val && q.Val < root.Val {
		return lowestCommonAncestorv29(root.Left, p, q)
	}

	return root
}

func lowestCommonAncestorv28(root, p, q *TreeNode) *TreeNode {

	if p.Val > root.Val && q.Val > root.Val {
		return lowestCommonAncestorv28(root.Right, p, q)
	}

	if p.Val < root.Val && q.Val < root.Val {
		return lowestCommonAncestorv28(root.Left, p, q)
	}

	return root
}

func lowestCommonAncestorv27(root, p, q *TreeNode) *TreeNode {

	if p.Val > root.Val && q.Val > root.Val {
		return lowestCommonAncestorv27(root.Right, p, q)
	}

	if p.Val < root.Val && q.Val < root.Val {
		return lowestCommonAncestorv27(root.Left, p, q)
	}

	return root
}

func lowestCommonAncestorv26(root, p, q *TreeNode) *TreeNode {

	if p.Val > root.Val && q.Val > root.Val {
		return lowestCommonAncestorv26(root.Right, p, q)
	}

	if p.Val < root.Val && q.Val < root.Val {
		return lowestCommonAncestorv26(root.Left, p, q)
	}

	return root
}

func lowestCommonAncestorv25(root, p, q *TreeNode) *TreeNode {

	if p.Val > root.Val && q.Val > root.Val {
		return lowestCommonAncestorv25(root.Right, p, q)
	}

	if p.Val < root.Val && q.Val < root.Val {
		return lowestCommonAncestorv25(root.Left, p, q)
	}

	return root
}

func lowestCommonAncestorv24(root, p, q *TreeNode) *TreeNode {

	if p.Val > root.Val && q.Val > root.Val {
		return lowestCommonAncestorv24(root.Right, p, q)
	}

	if p.Val < root.Val && q.Val < root.Val {
		return lowestCommonAncestorv24(root.Left, p, q)
	}
