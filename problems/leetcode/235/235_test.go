...
func TestLowestCommonAncestor(t *testing.T) {
	...
	testfuncs := []func(root, p, q *TreeNode) *TreeNode{
		lowestCommonAncestorv30,
		lowestCommonAncestorv29,
		lowestCommonAncestorv28,
		lowestCommonAncestorv27,
		lowestCommonAncestorv26,
		lowestCommonAncestorv25,
		lowestCommonAncestorv24,
		lowestCommonAncestorv23,
		lowestCommonAncestorv22,
		lowestCommonAncestorv21,
		lowestCommonAncestorv20,
		lowestCommonAncestorv19,
