...
func SearchInRotatedArrayv30(nums []int, target int) int {
	l, r := 0, len(nums)-1
...
func SearchInRotatedArrayv29(nums []int, target int) int {
...
func SearchInRotatedArrayv28(nums []int, target int) int {
	l, r := 0, len(nums)-1
...
func SearchInRotatedArrayv27(nums []int, target int) int {
	l, r := 0, len(nums)-1
...
func SearchInRotatedArrayv26(nums []int, target int) int {
	l, r := 0, len(nums)-1
...
func SearchInRotatedArrayv25(nums []int, target int) int {
	l, r := 0, len(nums)-1
...
func SearchInRotatedArrayv24(nums []int, target int) int {
	l, r := 0, len(nums)-1
...
func SearchInRotatedArrayv23(nums []int, target int) int {
	l, r := 0, len(nums)-1
...
func SearchInRotatedArrayv22(nums []int, target int) int {
	l, r := 0, len(nums)-1
...
func SearchInRotatedArrayv21(nums []int, target int) int {
	l, r := 0, len(nums)-1
