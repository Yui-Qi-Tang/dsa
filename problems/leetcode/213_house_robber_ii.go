...
func houseRobberIIv50(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv47(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv46(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv45(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv44(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv43(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv42(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv41(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv40(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv39(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv38(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv37(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv36(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv35(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv34(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv33(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv32(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv31(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv30(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv29(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv28(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv27(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv26(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv25(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv24(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
...
func houseRobberIIv23(nums []int) int {
	if len(nums) == 1 {
		return nums[0]
	}
