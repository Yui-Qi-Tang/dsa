...
func ClimbingStairsv52(n int) int {
	if n < 3 {
		return n
	}
...
func ClimbingStairsv49(n int) int {
	if n < 3 {
		return n
	}
	n1, n2 := 1, 2
...
func ClimbingStairsv48(n int) int {
	if n < 3 {
		return n
	}
...
func ClimbingStairsv47(n int) int {
	if n < 3 {
		return n
	}
...
func ClimbingStairsv46(n int) int {
	if n < 3 {
		return n
	}
...
func ClimbingStairsv45(n int) int {
	if n < 3 {
		return n
	}
...
func ClimbingStairsv44(n int) int {
	if n < 3 {
		return n
	}
...
func ClimbingStairsv43(n int) int {
	if n < 3 {
		return n
	}
