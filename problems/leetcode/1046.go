...
func (p pq30) Len() int           { return len(p) }
func (p pq30) Less(i, j int) bool { return p[i] > p[j] }
func (p *pq30) Push(x any)        { *p = append(*p, x.(int)) }
func (p pq30) Swap(i, j int)      { p[i], p[j] = p[j], p[i] }
func (p *pq30) Pop() any {
	s := *p
	n := s[s.Len()-1]
	*p = s[:s.Len()-1]
...
func lastStoneWeightv30(stones []int) int {
	if len(stones) == 0 {
		return 0
	}
...
func (p pq29) Len() int           { return len(p) }
func (p pq29) Less(i, j int) bool { return p[i] > p[j] }
func (p *pq29) Push(x any)        { *p = append(*p, x.(int)) }
func (p pq29) Swap(i, j int)      { p[i], p[j] = p[j], p[i] }
func (p *pq29) Pop() any {
	s := *p
	n := s[s.Len()-1]
	*p = s[:s.Len()-1]
...
func lastStoneWeightv29(stones []int) int {
	if len(stones) == 0 {
		return 0
	}
...
func (p pq28) Len() int           { return len(p) }
func (p pq28) Less(i, j int) bool { return p[i] > p[j] }
func (p *pq28) Push(x any)        { *p = append(*p, x.(int)) }
func (p pq28) Swap(i, j int)      { p[i], p[j] = p[j], p[i] }
func (p *pq28) Pop() any {
	s := *p
	n := s[s.Len()-1]
	*p = s[:s.Len()-1]
...
func lastStoneWeightv28(stones []int) int {
	if len(stones) == 0 {
		return 0
	}
...
func (p pq27) Len() int           { return len(p) }
func (p pq27) Less(i, j int) bool { return p[i] > p[j] }
func (p *pq27) Push(x any)        { *p = append(*p, x.(int)) }
func (p pq27) Swap(i, j int)      { p[i], p[j] = p[j], p[i] }
func (p *pq27) Pop() any {
	s := *p
	n := s[s.Len()-1]
	*p = s[:s.Len()-1]
...
func lastStoneWeightv27(stones []int) int {
	if len(stones) == 0 {
		return 0
	}
...
func (p pq26) Len() int           { return len(p) }
func (p pq26) Less(i, j int) bool { return p[i] > p[j] }
func (p *pq26) Push(x any)        { *p = append(*p, x.(int)) }
func (p pq26) Swap(i, j int)      { p[i], p[j] = p[j], p[i] }
func (p *pq26) Pop() any {
	s := *p
	n := s[s.Len()-1]
	*p = s[:s.Len()-1]
...
func lastStoneWeightv26(stones []int) int {
	if len(stones) == 0 {
		return 0
	}
...
func (p pq25) Len() int           { return len(p) }
func (p pq25) Less(i, j int) bool { return p[i] > p[j] }
func (p *pq25) Push(x any)        { *p = append(*p, x.(int)) }
func (p pq25) Swap(i, j int)      { p[i], p[j] = p[j], p[i] }
func (p *pq25) Pop() any {
	s := *p
	n := s[s.Len()-1]
	*p = s[:s.Len()-1]
...
func lastStoneWeightv25(stones []int) int {
	if len(stones) == 0 {
		return 0
	}
