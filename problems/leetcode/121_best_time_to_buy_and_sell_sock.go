...
func maxProfitV65(prices []int) int {
...
func maxProfitV62(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
...
func maxProfitV61(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
	for l < r && r < n {
		if prices[r] > prices[l] {
			result = max(result, prices[r]-prices[l])
...
func maxProfitV60(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
...
func maxProfitV59(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
...
func maxProfitV58(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
...
func maxProfitV57(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
...
func maxProfitV56(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
...
func maxProfitV55(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
...
func maxProfitV54(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
...
func maxProfitV53(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
...
func maxProfitV52(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
...
func maxProfitV51(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
...
func maxProfitV50(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
...
func maxProfitV49(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
...
func maxProfitV48(prices []int) int {
	l, r, n, result := 0, 1, len(prices), 0
