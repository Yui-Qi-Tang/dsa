...
func minPathSumv50(grid [][]int) int {
...
func minPathSumv49(grid [][]int) int {
	m, n := len(grid), len(grid[0])
	for i := 0; i < m; i++ {
		for j := 0; j < n; j++ {
			if i == 0 && j == 0 {
...
func minPathSumv48(grid [][]int) int {
	m, n := len(grid), len(grid[0])
	for i := 0; i < m; i++ {
		for j := 0; j < n; j++ {
			if i == 0 && j == 0 {
...
func minPathSumv47(grid [][]int) int {
	m, n := len(grid), len(grid[0])
	for i := 0; i < m; i++ {
		for j := 0; j < n; j++ {
			if i == 0 && j == 0 {
...
func minPathSumv46(grid [][]int) int {
	m, n := len(grid), len(grid[0])
...
func minPathSumv45(grid [][]int) int {
	m, n := len(grid), len(grid[0])
	for i := 0; i < m; i++ {
		for j := 0; j < n; j++ {
			if i == 0 && j == 0 {
...
func minPathSumv44(grid [][]int) int {
	m, n := len(grid), len(grid[0])
...
func minPathSumv43(grid [][]int) int {
	m, n := len(grid), len(grid[0])
	for i := 0; i < m; i++ {
		for j := 0; j < n; j++ {
			if i == 0 && j == 0 {
...
func minPathSumv42(grid [][]int) int {
	m, n := len(grid), len(grid[0])
	for i := 0; i < m; i++ {
		for j := 0; j < n; j++ {
			if i == 0 && j == 0 {
...
func minPathSumv41(grid [][]int) int {
	m, n := len(grid), len(grid[0])
	for i := 0; i < m; i++ {
		for j := 0; j < n; j++ {
			if i == 0 && j == 0 {
...
func minPathSumv40(grid [][]int) int {
	m, n := len(grid), len(grid[0])
	for i := 0; i < m; i++ {
		for j := 0; j < n; j++ {
			if i == 0 && j == 0 {
...
func minPathSumv39(grid [][]int) int {
	m, n := len(grid), len(grid[0])
	for i := 0; i < m; i++ {
		for j := 0; j < n; j++ {
			if i == 0 && j == 0 {
...
func minPathSumv38(grid [][]int) int {
	m, n := len(grid), len(grid[0])
	for i := 0; i < m; i++ {
		for j := 0; j < n; j++ {
			if i == 0 && j == 0 {
...
func minPathSumv37(grid [][]int) int {
	m, n := len(grid), len(grid[0])
...
func minPathSumv36(grid [][]int) int {
	m, n := len(grid), len(grid[0])
	for i := 0; i < m; i++ {
		for j := 0; j < n; j++ {
			if i == 0 && j == 0 {
...
func minPathSumv35(grid [][]int) int {
	m, n := len(grid), len(grid[0])
	for i := 0; i < m; i++ {
		for j := 0; j < n; j++ {
			if i == 0 && j == 0 {
...
func minPathSumv34(grid [][]int) int {
	m, n := len(grid), len(grid[0])
...
func minPathSumv33(grid [][]int) int {
	m, n := len(grid), len(grid[0])
	for i := 0; i < m; i++ {
		for j := 0; j < n; j++ {
			if i == 0 && j == 0 {
...
func minPathSumv32(grid [][]int) int {
	m, n := len(grid), len(grid[0])
	for i := 0; i < m; i++ {
		for j := 0; j < n; j++ {
			if i == 0 && j == 0 {
...
func minPathSumv31(grid [][]int) int {
	m, n := len(grid), len(grid[0])
...
func minPathSumv30(grid [][]int) int {
	m, n := len(grid), len(grid[0])
...
func minPathSumv29(grid [][]int) int {
	m, n := len(grid), len(grid[0])
...
func minPathSumv28(grid [][]int) int {
	m, n := len(grid), len(grid[0])
...
func minPathSumv27(grid [][]int) int {
	m, n := len(grid), len(grid[0])
