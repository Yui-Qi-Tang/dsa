...
func maxDepthv30(root *TreeNode) int {
	if root == nil {
		return 0
	}

	return 1 + max(maxDepthv30(root.Left), maxDepthv30(root.Right))
}

func maxDepthv29(root *TreeNode) int {
	if root == nil {
		return 0
	}

	return 1 + max(maxDepthv29(root.Left), maxDepthv29(root.Right))
}
...
func maxDepthv27(root *TreeNode) int {
	...
	return 1 + max(maxDepthv27(root.Left), maxDepthv27(root.Right))
}

func maxDepthv26(root *TreeNode) int {
	if root == nil {
		return 0
	}

	return 1 + max(maxDepthv26(root.Left), maxDepthv26(root.Right))
}
