...
func swapLexOrderv52(str string, pairs [][]int) string {
...
func swapLexOrderv51(str string, pairs [][]int) string {
	conns := make([][]int, len(str))
	for _, pair := range pairs {
		v1, v2 := pair[0]-1, pair[1]-1
		conns[v1] = append(conns[v1], v2)
...
func swapLexOrderv50(str string, pairs [][]int) string {
	conns := make([][]int, len(str))
	for _, pair := range pairs {
		v1, v2 := pair[0]-1, pair[1]-1
		conns[v1] = append(conns[v1], v2)
...
func swapLexOrderv49(str string, pairs [][]int) string {
	conns := make([][]int, len(str))
	for _, pair := range pairs {
		v1, v2 := pair[0]-1, pair[1]-1
		conns[v1] = append(conns[v1], v2)
